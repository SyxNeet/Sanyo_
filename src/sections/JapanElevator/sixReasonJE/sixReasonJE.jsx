...
const SixReasonJE = ({isMobile,data,isJapan}) => {
  return (
    <section className='relative sixReasonsJE pt-[9.06rem] max-md:pt-[3.5rem] mb-[3rem]'>
      ...
      />
      <SixReasons isMobile={isMobile} data={data} isJapan={isJapan}/>
    </section>
  )
}
