  ...
  return (
    <section className='flex flex-col md:flex-row flex-nowrap md:px-[3.75rem] px-3 pt-6 pb-10 md:pt-12 md:pb-16'>
      ...
      <div className='md:basis-1/2 max-md:mt-[2.19rem]'>
        <div className='md:ml-[3.25rem] p-4 border border-yellow-500 rounded-[0.625rem] max-md:bg-[linear-gradient(180deg,rgba(209,179,123,0.20)_0%,rgba(255,255,255,0.20)_100%)]'>
          <iframe
            ...
            width='1920'
            height='700'
            className='border-none w-full md:w-[45.5625rem] h-[12.9375rem] md:h-[25.125rem] rounded-[0.375rem]'
            allowfullscreen=''
            loading='lazy'
