  ...
  return (
    <section className='mt-[8rem] max-md:mt-[3.13rem]'>
      <div className='mx-auto flex flex-col justify-center items-center mb-[3rem] max-md:w-[20.625rem] max-md:mb-[1.25rem]'>
        ...
        >
          <h2
            className='text-[3.125rem] font-SVNLagu font-semibold leading-1.3 text-yellow-500 max-md:text-[1.5rem] [&>p>strong]:font-semibold [&>p>strong]:text-yellow-500'
      ...
      <div className='flex flex-col items-center'>
        <div className='flex items-center justify-between mt-[1.63rem] max-w-[29.9375rem] w-full max-md:max-w-none max-md:px-3'>
          <ButtonSLide
            className='swiper-button-prev-team border-yellow-500 transition ease-in cursor-pointer w-[3.5rem] h-[3.5rem] md:hover:border-white md:hover:bg-yellow-500 max-md:bg-yellow-500 max-md:border-yellow-500 max-md:w-[2.5rem] max-md:h-[2.5rem]'
            classNameSvg={
              'w-[1rem] h-[1rem] text-yellow-500 md:group-hover:text-white max-md:text-black max-md:w-[0.875rem] max-md:h-[0.875rem]'
            }
          />
          <div className='flex flex-col items-center justify-center'>
            <span className='font-Iciel text-[0.875rem] font-normal leading-1.5 uppercase text-grey-900 max-md:text-[0.625rem]'>
              {activeSlide?.chuc_vu}
            </span>
            <span className='text-[1.375rem] font-extrabold leading-1.4 capitalize font-SVNLagu max-md:text-[1rem]'>
              {activeSlide?.name}
            </span>
          </div>
          <ButtonSLide
