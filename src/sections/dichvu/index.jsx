...
export default function DichVu({isMobile ,data}) {
  const {header,slideCommit,certificate,procedure,operate_elevator,list_team,actual_construction} = 
  ...
  return (
    <main>
      ...
      {typeof window !== 'undefined' && window.innerWidth < 1024 ? <ProcedureMb data={procedure||{}}/> : <Procedure data={procedure||{}}/>}
