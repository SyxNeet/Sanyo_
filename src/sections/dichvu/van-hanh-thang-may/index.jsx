  ...
  return (
    <section className='mt-[8rem] max-md:mt-[3rem]'>
      <div className='md:hidden flex flex-col justify-center items-center px-3 '>
        <h2 className='text-[1.5rem] font-SVNLagu w-[14.625rem] mb-[0.62rem] font-semibold [&>p>strong]:text-yellow-500 [&>p>strong]:font-semibold' dangerouslySetInnerHTML={{__html:data?.heading}}>
      ...
      >
        ...
        <SwiperSlide className={`${isMobile ? '!hidden' : ''}`}>
          <div className='flex flex-col items-center justify-center py-[1.5rem] px-4'>
            <h2 className='font-SVNLagu text-center text-[3rem] font-semibold leading-[134%] text-grey-900 mb-[0.75rem] [&>p>strong]:font-semibold [&>p>strong]:text-yellow-500' dangerouslySetInnerHTML={{__html:data.heading}}>
