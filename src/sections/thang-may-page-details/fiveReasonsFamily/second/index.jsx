...
const SecondReasons = ({lang, isMobile,data}) => {
  ...
  return (
    <div>
      ...
      <div className='flex'>
        <div
          className='w-[50%] border-r border-[rgba(28,32,28,0.10)] relative  flex justify-end items-center overflow-hidden max-h-[56.25rem] h-[56.25rem] max-md:hidden max-md:border-none'
        >
