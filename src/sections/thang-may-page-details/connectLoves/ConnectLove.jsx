...
<Fade direction='left' triggerOnce>
     ...
     <Fade triggerOnce>   <div className='w-[0.0625rem] h-[26.3125rem] bg-[rgba(28,32,28,0.10)] mx-[4.81rem] max-md:hidden'></div></Fade>
<Fade direction='right' triggerOnce>
    ...
    <Fade direction='up' fraction={0} triggerOnce>  <SlideOnlyImages data={data?.slide} className={'!h-[33.9375rem]'} /></Fade>
    </section>
  )
}
