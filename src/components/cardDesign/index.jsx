...
const CardDesign = ({ data }) => { 
  return (
    data && <div className='bg-[white] rounded-xl h-[32.625rem] flex flex-col relative max-md:h-full max-md:rounded-none'>
          <Image
      ...
      <Image src={data?.imgUrl || "/images/cophop/gach.png"} alt='img-cach' width={1200} height={1200} quality={100} className='w-[18.0625rem] h-[18.0625rem] relative z-10 mx-auto max-md:w-[8.375rem] max-md:h-[8.375rem] max-md:mb-4' />
    </div>
  )
}
