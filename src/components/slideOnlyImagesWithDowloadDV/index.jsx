    ...
    <div className='mt-6 md:mt-[4.12rem]'>
      <div className='flex px-[6.25rem] max-md:w-full max-md:px-3'>
        <div className='relative w-[70%] border-r max-md:w-full max-md:border-none '>
          ...
          ></h1>
          <span className='w-[40.125rem] font-Iciel text-base font-normal leading-[188%] text-justify mb-20 block max-md:w-full max-md:text-[0.875rem] max-md:mb-5' dangerouslySetInnerHTML={{__html: data?.description}}>
          </span>
        ...
        <div className='w-[30%] max-md:hidden'>
          <div className='ml-28 mt-[10%] relative w-16  h-[14.3125rem] bg-slate-400 '>
            ...
            <div className='dowloadElevator absolute left-full bottom-[13%] w-[13.9375rem] h-[3.9375rem] flex items-center justify-center cursor-pointer '>
              <Link href={data?.link} className='uppercase font-Iciel text-base font-medium leading-[120%] mr-[0.87rem]'>
                tải xuống ngay
              </Link>
