        ...
        if (bar1 && bar2) {
          ...
          if (activeImage - 1 >= 0) {
            ...
            bar1.style.translate =
              decodeTranslateValue(bar1) + translateBar1 + 'px'
            bar2.style.translate =
              -(decodeTranslateValue(bar2) + translateBar2) + 'px'
            setTimeout(() => {
              bars.forEach((bar, i) => {
                if (i !== activeImage) {
              ...
              bar2.style.transition = 'all 0s linear'
              bar2.style.translate = 'none'
              bar2.style.opacity = 1
              setTimeout(() => {
                bars.forEach((bar, i) => {
                  if (i !== activeImage) {
                    bar.style.transition = 'all 0.7s linear'
                  }
                })
                bar2.style.transition = 'all 0.7s linear'
              }, 1)
            }, 700)
          } else {
            const translateBar1 =
        ...
        (_, i) => {
          return (
            <li
              ...
              className={clsx(
                `pagination-bar pagination-bar-${i} grow rounded-none bg-grey-0 h-[0.125rem] md:h-[0.25rem] mx-1 md:mx-3 opacity-40 transition-all duration-700 ease-linear`,
              )}
            />
          )
        },
