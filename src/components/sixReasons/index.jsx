        ...
        <div className='flex justify-between mb-[1.96rem]'>
          ...
          <div className='pr-[7rem] max-md:hidden'>
            <div className='flex'>
              <ButtonSLide
                className={
                  ` swiper-button-prev-sixReasons ${isJapan?'border-c-nht hover:bg-c-nht':'!border-yellow-500 hover:!bg-yellow-500'} transition ease-in cursor-pointer w-[3.5rem] h-[3.5rem] mr-[0.75rem] md:hover:border-white md:hover:bg-[#FE4127] max-md:bg-yellow-500 max-md:border-yellow-500 max-md:w-[2.5rem] max-md:h-[2.5rem]`
                }
                classNameSvg={
              ...
              <ButtonSLide
                className={
                  ` swiper-button-next-sixReasons ${isJapan?'border-c-nht hover:bg-c-nht':'!border-yellow-500 hover:!bg-yellow-500'} transition ease-in cursor-pointer w-[3.5rem] h-[3.5rem] mr-[0.75rem] md:hover:border-white md:hover:bg-[#FE4127] max-md:bg-yellow-500 max-md:border-yellow-500 max-md:w-[2.5rem] max-md:h-[2.5rem]`
                }
                classNameSvg={
